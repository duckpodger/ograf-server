...
function setupServerApi(router, graphicsStore, rendererManager) {
    ...
    serverApiRouter.get(`/serverApi/internal/graphics/graphic/:graphicId/:graphicVersion/graphic`, handleError(async (ctx) => graphicsStore.getGraphicModule(ctx)));
    serverApiRouter.get(`/serverApi/internal/graphics/graphic/:graphicId/:graphicVersion/resources/:localPath*`, handleError(async (ctx) => graphicsStore.getGraphicResource(ctx)));
    ...
    serverApiRouter.post("/serverApi/internal/renderers/renderer/:rendererId/target/:renderTargetId/invokeAction", handleError(async (ctx) => rendererManager.invokeGraphicAction(ctx)));
}
